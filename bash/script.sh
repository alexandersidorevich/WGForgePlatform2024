...
#    4. Ask user to enter some information (text or numbers)
#    5. Write the information to the "info.txt" file
#    6. Print a message to the user letting them know the directory and the file were created successfully
#    7. Exit the script
...
# Task №4
# ------------------------------------------------------------------------------------------------
# Create a bash script that will loop through a given directory,
# read all the image files (.jpg and .png) and then
# create a text file with the name of each image file followed by the dimensions of the image.
